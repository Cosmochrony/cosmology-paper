\section{Galaxy Rotation Curves}
  ...
  \input{../code/03-rotation_curves/001-data_method}
  \input{../code/03-rotation_curves/002-fits}
  \input{../code/03-rotation_curves/003-residuals}
  \input{../code/03-rotation_curves/004-universality}
  \input{../code/03-rotation_curves/005-physical-interpretation-of-the-saturation-amplitude}
  \input{../code/03-rotation_curves/006-rc_summary}
