\section{Galaxy Rotation Curves}
  ...
  This motivates treating the same $a_\star$ as a single effective scale
  consistently appearing in both galactic outskirts and low-density cosmic
  environments, without modifying early-time cosmology.
