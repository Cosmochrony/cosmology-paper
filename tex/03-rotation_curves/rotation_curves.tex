\section{Cosmic Voids and the Hubble Tension}
  ...
  \subsection{Local Expansion in Low-Density Environments}
    ...
    representative of the global cosmological background.
    ...
    by matter densities well below the cosmic mean.
    ...
    We therefore distinguish between a global expansion rate $H_{\mathrm{global}}$,
    defined by the homogeneous background, and an effective local expansion rate
    $H_{\mathrm{loc}}$, inferred from observations within a given environment.
  ...
  \subsection{Connection to the Hubble Tension}
    ...
    the Hubble constant and late-time local measurements.
  ...
  \subsection{Observable Signatures}
    ...
    including redshift drift and weak lensing.
