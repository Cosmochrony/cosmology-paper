...
effective gravitational response at the level of kinematic inference,
  ...
  phenomenology testable with current and forthcoming observations. We finally isolate a structural expansion sector:
  under an explicitly stated rank--time dictionary hypothesis,
  ...
  and the naive state-volume reading is quantitatively excluded.}
...
\begin{document}
  ...
  \input{05b-history-branching/history_branching}
