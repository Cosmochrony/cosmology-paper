\subsection{Minimal Assumptions and Domain of Validity}
  ...
  Within the underlying programme, bounded relaxation flux is stated as the
  capacity axiom [A-cap], with a Born--Infeld-type effective action as its
  saturation candidate~\cite{Beau2026c}; deriving the specific saturation
  function $\mu(x)$ from that structure is an open task and is explicitly
  not claimed here.
