\subsection{Operational Saturation Scale}
  ...
  In the underlying relational description, the invariant bound $c_{\mathrm{BI}}$
  ...
  $c_{\mathrm{BI}}^2$, of dimension velocity squared, not the rate bound itself.
  ...
  \begin{equation}
    ...
    a_\star(z) \sim \kappa \frac{c_{\mathrm{BI}}^2}{\ell(z)},
  \end{equation}
