\subsection{Cosmological Descriptive Resolution}
  ...
  The parametrization $a_\star(z) \sim \kappa\, c_{\mathrm{BI}}^2 / \ell(z)$
  ...
  \begin{equation}
    ...
    a_\star(z) \sim \kappa\, \frac{c_{\mathrm{BI}}^2}{c}\, H(z),
  \end{equation}
  and in projectable regimes $c_{\mathrm{BI}} \to c$, so that
  \begin{equation}
