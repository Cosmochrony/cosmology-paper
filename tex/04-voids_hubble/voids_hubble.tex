\section{Cosmic Voids and the Hubble Tension}
  ...
  \subsection{Effective Expansion Rate in Voids}
    ...
    In this regime, the effective description operates close to the effective resolution limit of the description.
    ...
    \begin{equation}
      ...
      =
      H_{\mathrm{global}}
      \left( 1 + \delta_{\mathrm{eff}} \right) ,
      \label{eq:hloc}
    \end{equation}
    ...
    the effective projection onto a geometric description operates closer to its
    saturation limit.
    This induces a local dilation of inferred metric relations,
    which we refer to as a \emph{geometric relaxation offset}.
