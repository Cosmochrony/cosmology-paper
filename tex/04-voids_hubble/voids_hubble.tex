\section{Cosmic Voids and the Hubble Tension}
  ...
  \subsection{Predicted Amplitude and Redshift Dependence}
    ...
    deviation from the global expansion rate is not a free phenomenological parameter.
    Once the saturation scale $a_\star$ is fixed by galactic dynamics, the expected
    environmental offset in the inferred Hubble constant is constrained to a narrow range.
    ...
    \begin{equation}
      ...
      5\text{--}10\% ,
    \end{equation}
    consistent with the observed discrepancy between local distance-ladder measurements
    ...
    Importantly, deviations significantly outside this range would falsify the framework.
    Larger offsets would require unrealistically deep or extended underdensities,
    while substantially smaller deviations would be incompatible with the level of
    saturation required to reproduce galaxy rotation curves.
